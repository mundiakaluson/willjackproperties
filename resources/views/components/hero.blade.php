    ...
    <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
        ...
        <div class="text-center lg:w-2/3 w-full">
            ...
            <div class="flex justify-center">
                <button
                    class="inline-flex text-white bg-soft-gray border-0 py-2 px-6 focus:outline-none hover:bg-silver-sonic rounded text-lg">Button</button>
                <button
                    class="ml-4 inline-flex text-white text-gray-700 bg-soft-gray border-0 py-2 px-6 focus:outline-none hover:silver-sonic rounded text-lg">Button</button>
            </div>
        </div>
    </div>
</section>